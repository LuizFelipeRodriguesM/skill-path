    ...
    <div className="w-full space-y-6">
      {parts.map((part, index) => (
        <div key={index}>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:text-foreground prose-p:text-foreground/80 prose-strong:text-foreground prose-code:text-[var(--brand-primary)] prose-code:bg-white/5 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-pre:bg-white/5 prose-pre:border prose-pre:border-white/15 prose-a:text-[var(--brand-primary)] prose-a:no-underline hover:prose-a:underline prose-li:text-foreground/80">
