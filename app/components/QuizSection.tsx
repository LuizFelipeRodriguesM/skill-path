        ...
        {questions.map((q, qIndex) => (
          <div key={qIndex} className="space-y-3">
            <p className="font-medium text-foreground/90">
              <span className="text-[var(--brand-primary)]">Questão {qIndex + 1}:</span>{" "}
              {q.question}
            </p>
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-lg border transition-all ${
                      showCorrect
                        ...
                        : isSelected
                        ? "bg-[var(--brand-primary)]/20 border-[var(--brand-primary)] text-foreground"
        ...
        {!showResults ? (
          <button
            ...
            className={`px-6 py-2 rounded-lg font-medium transition ${
              allAnswered
                ? "bg-gradient-to-r from-[var(--brand-primary)] to-[var(--brand-secondary)] text-white hover:brightness-110"
