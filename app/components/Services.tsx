      ...
      <div className="mt-8 space-y-8 text-center max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-left">
          <div className="flex items-start gap-4">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-[var(--brand-primary)] to-[var(--brand-secondary)] text-white font-semibold text-sm flex-shrink-0">
              1
            </div>
            <div>
